...
namespace mintosParser {
    class Program
    {
        ...
        public static MintosParser.CSVParser parser { get; set; }
        ...
        public static RootCommand rootCommand = new RootCommand("Mintos CSV parser transforms mintos CSV statementfiles into CSV files that can be easily imported by Portfolio Performance") {
            logLevelOption, outputEncodingOption, inputEncodingOption,inputLanguageOption, inputSeperatorOption, outputSeperatorOption, DepotNameOption,AccountNameOption, InputFileArgument, OutputFileArgument
        };
